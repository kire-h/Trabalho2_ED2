...
o núcleo identificado pelo k-core não coincide com os principais hubs. Nesta rede, os maiores hubs são nós isolados com grau 4 ou ligeiramente maior, correspondendo a rotatórias de grande porte ou cruzamentos complexos dispersos (muitos deles localizados em rodovias de acesso ou na periferia, onde o desenho das vias converge para poucos pontos). Por outro lado, como os nós de uma malha urbana possuem uma limitação física de conexões diretas por causa da geometria das ruas, a decomposição em 2-core elimina progressivamente essas ramificações periféricas e os hubs isolados. O núcleo resultante (o max core) se concentra na região com a malha viária mais densa, compacta e intensamente quadriculada do mapa — tipicamente áreas centrais e comerciais consolidadas (como o Alecrim, Tirol ou Petrópolis) —, onde os nós formam um bloco altamente resiliente e interconectado, mesmo que individualmente cada cruzamento ali dentro tenha poucas vias conectadas a ele.

### O que a métrica de betweenness revela que o grau não revela?

Para este grafo, o grau falha completamente em diferenciar a relevância das vias porque atribui exatamente o mesmo peso a um cruzamento residencial interno e a um entroncamento logístico vital. Por exemplo, um cruzamento comum de 4 esquinas nas ruas internas de Capim Macio ou de Nova Descoberta terá grau = 4, exatamente o mesmo grau de um nó crucial que conecta as alças de acesso do Complexo Viário do Quarto Centenário ou os acessos da Avenida Bernardo Vieira. O grau olha apenas para o número de ruas que chegam ao nó, tratando locais de tráfego local e de tráfego de passagem como geometricamente idênticos.

A métrica de betweenness, por outro lado, revela a dependência estrutural do fluxo interregional da cidade, identificando nós que funcionam como os únicos caminhos viáveis e mais curtos entre as zonas de Natal. Ela evidencia o abismo de importância entre esses nós ao destacar de forma massiva os gargalos de transição de bacia e transporte de massa, como os eixos de escoamento da Ponte Newton Navarro e da Ponte de Igapó (gargalos críticos que ligam a Zona Norte ao Centro), e os pontos de saturação ao longo do corredor estrutural da Avenida Salgado Filho/BR-101 e da Avenida Engenheiro Roberto Freire (que canalizam o fluxo das Zonas Sul e Leste). O betweenness revela quais pontos específicos do seu grafo isolariam bairros inteiros e colapsariam o tráfego macroscópico caso fossem removidos, algo que o grau esconde sob a aparente homogeneidade de cruzamentos com 3 ou 4 conexões.
...
No layout geográfico real, a rede é rigidamente ditada pela distância física e pelas barreiras naturais da cidade, espelhando perfeitamente a segregação espacial causada pelo Rio Potengi e pelo Oceano Atlântico. Essa visualização esconde a real importância das vias, pois uma linha longa (como a que representa a Ponte Newton Navarro) parece apenas um traço esticado conectando o vazio da Zona Norte ao resto da cidade, fazendo com que regiões geograficamente periféricas ou extensas pareçam desconectadas ou irrelevantes para o funcionamento do todo.

Já no layout estrutural, a geometria real é ignorada e a rede é rearranjada puramente pela força das suas conexões (topologia). Como resultado, as distâncias físicas desaparecem e o grafo "puxa" para o centro os eixos que possuem maior centralidade de intermediação e proximidade, colapsando a cidade em torno de seus verdadeiros corações viários. Os nós das alças de acesso da Ponte de Igapó e da Ponte Newton Navarro, que geograficamente ficam isolados nas extremidades da imagem, no layout estrutural são violentamente arrastados para o centro do grafo, revelando de forma visual que eles agem como cordões umbilicais que mantêm a Zona Norte unida à malha principal. Da mesma forma, bairros com tecidos urbanos altamente densos e integrados (como as malhas comerciais do Alecrim e do Tirol) se fundem visualmente em aglomerados supercompactos no centro do layout estrutural devido à sua alta conectividade interna (k-core elevado), enquanto rodovias longas e de tráfego rápido de Parnamirim ou Macaíba, que ocupam muito espaço no mapa real, são jogadas para a periferia do grafo estrutural por funcionarem apenas como ramificações lineares com poucos cruzamentos secundários.
